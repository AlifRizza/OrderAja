...
import 'package:order_aja_apps/pages/success_kasir.dart';
...
class DetailOrderWaiter extends StatelessWidget {
  const DetailOrderWaiter({super.key});
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => DetailOrderWaiter(),
                        ));
                      },
                    ),
                    IconButton(
